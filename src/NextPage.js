  ...
  return (
    <div className="d-flex flex-column">
      <div className="flex-grow-1 container-fluid">
        <div className="row p-3 p-md-4 shadow-lg" style={{ marginTop: 'auto', backgroundColor: "aliceblue", borderRadius: "10px" }}>
          ...
          <div className="col-md d-flex justify-content-center"> {/* Adjust the width by changing the col-md-6 value */}
            <button
              type="button"
              className="btn btn-lg  bg-animation" // Adjust the size using btn-lg, btn-sm, etc.
              style={{ marginTop: '15px' }} // Add padding top
